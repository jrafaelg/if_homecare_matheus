    ...
    <div class="dashboard">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="meus_agendamentos.php">📋 Minhas Solicitações</a></li>
        ...
        <main class="main-content">
            ...
            <?php if ($stats['avaliacoes_pendentes'] > 0): ?>
                <div class="alert alert-info">
                    ...
                    <a href="meus_agendamentos.php">Avaliar agora</a>
                </div>
            <?php endif; ?>
            ...
            <div class="card">
                <div class="card-header d-flex justify-between align-center">
                    ...
                    <a href="meus_agendamentos.php" class="btn btn-primary btn-sm">Ver Todas</a>
                </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($solicitacoes as $solicitacao): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="meus_agendamentos.php?id=<?= $solicitacao['id'] ?>" class="btn btn-secondary btn-sm">
                                                Detalhes
                                            </a>
                                        </td>
                                    </tr>
